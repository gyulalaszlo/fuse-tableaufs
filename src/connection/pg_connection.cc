...
namespace {
  ...
  Result< slice<char> > io_op( PgConnection* connection, OpType op,  Loid loid, slice<char> buffer, off_t offset, size_t size)
  {
...
namespace tableauFS {
  ...
  Result< slice<char>> PgConnection::read_lo_block( Loid loid, slice<char> buffer, size_t size, off_t offset ) {
